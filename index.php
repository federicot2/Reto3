...
<body>
	...
	$nombre = $apellido = $direccion = $fecha = $genero ="";

	if (isset($_POST['submit'])) {
			if (strlen($_POST['nombre']) >= 1 && strlen($_POST['apellido']) >= 1 && strlen($_POST['direccion']) >= 1 && strlen($_POST['fecha']) >= 1 && strlen($_POST['genero']) >= 1) {
			...
			$consulta = "INSERT INTO usuarios(nombre,apellido,direccion,fecha,genero) VALUES ('$nombre','$apellido','$direccion','$fecha','$genero')";
